...
reader.addEventListener('load', () => {
    ...
    if (a.isSucc != 'placeholder') a.isSucc = new Function('a','data', a.isSucc)
    if (a.expand != 'placeholder') a.expand = new Function('a', 'fs', 'data', a.expand)
    if (a.expandLimit != 'placeholder') a.expandLimit = new Function('fs','data', a.expandLimit)
    notations.push(a)
    updateNotation()
})

...
reader.addEventListener('load', () => {
    ...
    if (a.read != 'placeholder') a.read = new Function('a', 'data', a.read)
    if (a.write != 'placeholder') a.write = new Function('a', 'data', a.write)
    if (a.compare != 'placeholder') a.compare = new Function('a', 'b', 'data', a.compare)
    if (a.isSucc != 'placeholder') a.isSucc = new Function('a', 'b', 'data', a.isSucc)
    if (a.expand != 'placeholder') a.expand = new Function('a', 'b', 'data', a.expand)
    if (a.expandLimit != 'placeholder') a.expandLimit = new Function('a', 'b', 'data', a.expandLimit)
    notations.push(a)
    updateNotation()
})
